...
<div class="ProfileIconHoverChangeColor dropdown-container"  on:mouseenter={() => ProfileIconisHovered = true} on:mouseleave={() => ProfileIconisHovered = false}>
	<button>	
		<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
			...
			<g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill={ProfileIconisHovered ? '#535353' : '#666666'} stroke="none">
